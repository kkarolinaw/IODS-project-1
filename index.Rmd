...
https://kkarolinaw.github.io/IODS-project-1/#iods-course-project
---
***
...
learn14$Age
learn14$Attitude
<DID NOT WORK AT FIRST TIME learn14$Deep>
<DID NOT WORK AT FIRST TIME learn14$Stra>
<DID NOT WORK AT FIRST TIME learn14$Surf>
learn14$Points
...
Am sorry though about some of the text being in larger size, eventhough I removed all the useless hashtags from this text, they somehow did not change back to normal.. If you have any suggestions why this is happening, please let me know (: I will try to get the next weeks project to look a little bit better, but this should have all information needed :)
