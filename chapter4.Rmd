...
```
The scale command subtracts the column means from the corresponding columns and divide the difference with standard deviation. Here we can see the summary of Boston data set scaled. 
```{r}
...
lda.arrows <- function(x, myscale = 1, arrow_heads = 0.1, color = "red", tex = 0.75, choices = c(1,2)){
  ...
  arrows(x0 = 0, y0 = 0, 
         ...
         y1 = myscale * heads[,choices[2]], col=color, length = arrow_heads, cex = tex, col=color, pos=3) 
